...
public abstract class DataCollector {
    ...
    public QueryResult queryContent(QueryParameter queryParameter) {
        MessageParser messageParser = getParser();
        Meta meta = messageParser.parseResponeMeta(WebUtil.querySite(getUrl(), 1, getAllowedQuerriesPerSec(), queryParameter, this::getParams).get(0));
        ...
        responses.forEach(message -> queryResult.addArticles(messageParser.parseResponeData(message)));
    ...
    protected abstract MessageParser getParser();
}
